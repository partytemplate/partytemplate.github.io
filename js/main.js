$(function() {
    $("#wizard").steps({
        ...
        onStepChanging: function(event, currentIndex, newIndex) {
            ...
            if (newIndex === 4) {
                $('.steps ul li:nth-child(5) a').append('<img src="images/step-arrow.png" alt="" class="step-arrow">');
            } else {
    ...
    $('.steps ul li:nth-child(3) a').append('<img src="images/step-3.png" alt="">');
    $('.steps ul li:nth-child(4) a').append('<img src="images/step-4.png" alt="">');
